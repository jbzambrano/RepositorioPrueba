...
public class ShipperController {
    ...
    @PostMapping(value="searchShipper")
    ...
    public String guardarNuevoTransportista(Shipper shipper, RedirectAttributes attr) {
        ...
        if(shipper.getShipperId() !=0){
            attr.addFlashAttribute("msgCreate","Transportista actualizado correctamente");
        }else {
            attr.addFlashAttribute("msgCreate","Transportista creado correctamente");
        }
